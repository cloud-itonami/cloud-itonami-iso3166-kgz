(ns marketentry.phase
  "Phase 0->3 staged rollout for the Kyrgyz Republic (KGZ) market-entry
  compliance actor.
    ...
    Phase 3  supervised auto  -- governor-clean, high-confidence
                                 ...
                                 zakupki.gov.kg filing risk yet) may
  ...
  real zakupki.gov.kg tender response / equivalent filing package and
