(ns marketentry.store
  "SSoT for the Kyrgyz Republic (KGZ) market-entry compliance actor,
...
(defn demo-data
  ...
  the Kyrgyz Republic Art.24 -- does a declared initial probation
  period stay within the 3-month general / 6-month senior-management
  ceiling?); `:requires-inn?` / `:inn-verified?` are ground truth for
  the conditional TIN/ИНН check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Бишкек Соода ЖЧК" :procurement-channel "zakupki.gov.kg public procurement portal"
             ...
             :jurisdiction "KGZ" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :procurement-channel "zakupki.gov.kg public procurement portal"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :engages-local-staff-under-probation? false
             :requires-inn? true :inn-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Ош Экспорт ЖЧК" :procurement-channel "zakupki.gov.kg public procurement portal"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "KGZ" :status :intake}
    "eng-4" {:id "eng-4" :operator "Жалал-Абад Курулуш ЖЧК" :procurement-channel "zakupki.gov.kg public procurement portal"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "KGZ" :status :intake}
    "eng-5" {:id "eng-5" :operator "Каракол Импорт ЖЧК" :procurement-channel "zakupki.gov.kg public procurement portal"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :engages-local-staff-under-probation? false
             ...
             :drafted? false :submitted? false
             :jurisdiction "KGZ" :status :intake}
    "eng-6" {:id "eng-6" :operator "Талас Текстиль ЖЧК" :procurement-channel "zakupki.gov.kg public procurement portal"
